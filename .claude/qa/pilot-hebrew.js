...
async function synthRetry(text){let wait=60000;for(let a=0;a<4;a++){try{return await synth(text)}catch(e){if(!/429/.test(e.message)||a===3)throw e;console.error('Gemini 429 - waiting '+(wait/1000)+'s before retry '+(a+1)+'/3');await sleep(wait);wait*=2}}}
