...
const SUITE = [
  ...
  /* המשלים ל-teen-i18n, ולא חזרה עליו. זה בודק **רינדור** — מה
     נראה על המסך ובהקראה; זה בודק **מבנה** — ששלושת המילונים
     מחזיקים את אותם מפתחות ושאין ערך ריק.

     ולמה שניהם נחוצים, נמדד 18.9.2026 על אותו עץ: מפתח שנמחק
     לגמרי מ-TR_RU_BAG (״. סווגו את נקודות הקיצון.״) השאיר את
     teen-i18n **ירוק** — 576 שאלות בכל שפה, והמחרוזת לא נדגמה —
     ו-teentr נפל עליו. בדיקת רינדור רואה רק מה שנדגם; בדיקת
     מבנה רואה את הכול. */
