...
const SUITE = [
  ...
  { id: 'core',    args: [] },
  /* מנוע לימור — חוזה ה-Worker מול מודל מדומה (פעולות, אימות, שרשרת
  ...
  /* מנוע לימור בדפדפן אמיתי מול Worker מדומה: ההקשר שנשלח, פעולה
  ...
  /* השאלה שלימור מקבל — בשפת המסך. צילום הבעלים 23.9.2026: שאלה עברית
     בראש ״Ask the teacher״. הוכח אדום על math-teen שלפני התיקון: 96/96. */
  { id: 'tutor-lang', args: [], needsServer: true },
  /* הפאנל של לימור כשהמקלדת פתוחה — `visualViewport` מזויף, 360 ו-412,
