...
const RULES = [
  ...
  ['כסף',         stems('כסף', 'כספי', 'עושר', 'רווח', 'הפסד', 'השקע', 'בורס', 'הלווא', 'משכורת', 'ירוויח', 'תרוויח', 'תפסיד', 'ירוש[הת]', 'מחיר')],
  /* ״עשיר״ ו״עוני״ כמילה שלמה: ״הבית העשירי״ ו״צבעוני״ אינם כסף. נמצא על ידי היפטיה 3. */
  ['כסף (מילה)',  words('עני', 'עניים', 'עשיר', 'עשירה', 'עשירים', 'עוני', 'חוב', 'חובות')],
