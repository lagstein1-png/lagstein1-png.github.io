...
/* =====================================================================
   בדיקה 2: **השם שהלומד רואה הוא לימור, בארבע השפות.**
...
/* **`petJoshName` נוסף 16.9.2026, והוא הראה שהבדיקה צרה מדי.**
   ...
   נקראה ״פאולה״ בזמן שכפתור העזרה באותו מסך אמר ״לימור״, ושלוש
   זהויות ישבו במסך אחד: ״רובוט״ (התווית), ״פאולה״ (השם המוצע)
   ו״לימור״ (העוזר). הבדיקה עברה ירוק מפני שסרקה את `tutor.js`
...
/* **שני שמות ישנים, לא אחד — 15.9.2026.** הבעלים החליף ג׳וש→פאולה
   ב-14.9, ולמחרת פאולה→לימור. שניהם נשמרים כאן: העתקה הבאה עלולה
...
/* =====================================================================
   ...
   **נמצא 16.9.2026, והבעלים הוא שראה את זה ולא הבדיקה.** הוא כתב
   ״לימור עונה אותה תשובה״, ובבדיקה התברר שהתשובה הראשונה שהוא מקבל
   ...
   בזמן שהכפתור שנלחץ שנייה קודם אומר ״לימור — עזרה מהמורה״.
...
if (nameBad) console.log('  השם הוא לימור · ليمور · Лимор · Limor — ראו JOSH.md');
