/* =====================================================================
   tutor-lang.js — השאלה שברק מקבל כתובה בשפת המסך
   ...
   את `x.ask` הגולמי — המסך תורגם, מה שהגיע לברק לא.
...
(async () => {
  ...
  await b.close();
  console.log(`\n${APPS.length} אפליקציות, ${bad} שבהן שאלה עברית מגיעה לברק במסך בשפה אחרת`);
