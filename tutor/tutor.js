...
var L = {
he:{ btn:"עזרה מהמורה", title:"עזרה מהמורה", close:"סגירה", send:"שליחה",
...
ar:{ btn:"مساعدة من المعلّم", title:"مساعدة من المعلّم", close:"إغلاق", send:"إرسال",
...
ru:{ btn:"Помощь учителя", title:"Помощь учителя", close:"Закрыть", send:"Отправить",
...
en:{ btn:"Ask the teacher", title:"Ask the teacher", close:"Close", send:"Send",
