/* =====================================================================
   מנוע לימור — הלקוח המשותף (BARAK-CORE) · 16.9.2026
   ...
   **מה זה פותר.** שני כשלים של הגרסה הקודמת: ״לימור לא יודע כלום״ —
   כי השרת קיבל את התרגיל בלבד; ו״לימור אומר ׳נעבור למסך׳ ולא מעביר״ —
   ...
   2. **הפעולות** מוצהרות במתאם — שם, תיאור, פרמטרים ופונקציה
      ...
      **הקוד כאן מבצע**, ורק אם הביצוע הצליח מוצג הטקסט שמלווה
      אותה. נכשל — נוסח קבוע (`ACTION_FAILED`) במקומו. לימור אינו
