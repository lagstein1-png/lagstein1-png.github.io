...
/* --- מגדר הקול לפי שם ---
   ל-Web Speech API אין שדה מגדר, והשם הוא הרמז היחיד. מכשירים
   מדווחים את השם בשפת המערכת, ולכן מילון לטיני בלבד מפספס בדיוק
   את הקולות של קהל היעד: "הילה" ולא "Hila". קול נשי שסווג כגברי
   מקבל הרמת גובה שאינו צריך, והתוצאה נשמעת מעוותת. */
[['Carmit', 'f'], ['הילה', 'f'], ['כרמית', 'f'], ['سلمى', 'f'], ['هدى', 'f'],
 ['Ирина', 'f'], ['светлана', 'f'], ['Samantha', 'f'],
 ['Asaf', 'm'], ['אסף', 'm'], ['אברי', 'm'], ['حامد', 'm'], ['ماجد', 'm'],
 ['Дмитрий', 'm'], ['максим', 'm'],
 ['Google עברית', '?'], ['', '?']].forEach(function (c) {
  eq('מגדר הקול · ' + (c[0] || '(ריק)'), LC.tts.voiceGender(c[0]), c[1]);
});
