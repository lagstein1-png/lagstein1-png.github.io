...
שלוש הנגיעות, והמספרים בדוח שלך מגיעים מהפלט שלו. היום הוא
מחזיר "4 מאגרים · 7 נושאים · 91 פריטים".
...
קובץ. `lomda/data/` מכיל היום `civics.js`, `digital.js`, `money.js`,
`science.js` ו-`schema.js` — וזה הכול. מי שיאמר לך ש"התחילו את
זה" — תבקשי את שם הקובץ.
