...
**מי כותב:** ארתור, מהנדס התוכנה ומנהל הפרויקט.
...
**האחד — הענף `claude/new-exam-app-xkohvq` מיועד למחיקה.**
הוא סטייה של חודש מ-`main`, ומיזוג שלו יחזיר את הריפו לאחור.
הניסוחים שהיו בו עברו ל-`lomda/data/civics.js` ואומתו 288 מתוך
288. העותק המקומי נמחק; הרפרנס ב-GitHub נמחק בידי הבעלים.
אין לבנות עליו כלום.
