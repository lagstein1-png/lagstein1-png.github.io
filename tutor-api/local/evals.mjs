...
function judge(scn, lang, screen, d, turn) {
  ...
  /* **השם, בארבע כתבים — 16.9.2026.** ריצת barak-live 3 החזירה
     ...
     **וסבב שני, מריצת barak-live 4.** אחרי שהעברית נעלמה, ברוסית
     נשארו שלוש צורות לאותו בוט: ״Я — Barak״, ״Меня зовут Barak״
     ו-״Барак״. הרשימה ב-CORE הייתה רשימה שטוחה, ולכן המודל נאלץ
