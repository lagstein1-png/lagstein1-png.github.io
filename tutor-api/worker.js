...
const LIM = {
  ...
  /* שתי התקרות האלה הן חסם העלות, **ושתיהן אינן אותו דבר.**
     ...
     **1,000 הוא חמישים לומדים שמילאו את התקרה שלהם**, ולא
     חמישה. להשתיק את ג׳וש לכולם צריך מעכשיו חמישים כתובות
     שונות ולא אחת. להוריד או להעלות — מספר אחד כאן, והחשבון
     למעלה הוא היחס. */
  perDay: 20,          /* פניות ליום לכל כתובת IP — התקרה של הלומד */
  globalPerDay: 1000   /* חסם העלות של השירות כולו, ולא תקרת שימוש */
};
