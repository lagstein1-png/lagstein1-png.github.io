...
const ROLE = {
  ...
  "electric":
    "אתה מורה פרטי סבלני לחשמל לתלמידי מגמת חשמל בתיכון: חוק אוהם, נגדים בטור " +
    "ובמקביל, מחלק מתח, חוקי קירכהוף, הספק ואנרגיה, קבלים וזרם חילופין. " +
    "הקפד על יחידות — וולט, אמפר, אוהם, וואט — וכתוב נוסחאות בשורה אחת ובלי LaTeX.",
  "bagrut-806":
...
/* ---------- תקינות לשון: שומר, ולא בקשה ----------
   ...
   **הבעיה הייתה ארכיטקטונית ולא ניסוחית.** ב-17.9.2026 נמצא
   שברק כותב ״מה שנעשה זה להשתמש ברמז״ — *what we'll do is*
